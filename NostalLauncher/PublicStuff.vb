...
Module PublicStuff
    ...
    Public Const CONSTRING As String = "Data Source=JDLauncher.db;Version=3;Pooling=True;Synchronous=Off;journal mode=Memory;foreign keys=true;;"
    ...
    Public RAGNA_SPEECH As New List(Of String)(New String() {"TOO SOON! YOU HAVE AWAKENED ME TOO SOON, EXECUTUS!",
                                                             ...
                                                             "FOOL! YOU ALLOWED THESE INSECTS TO RUN RAMPANT THROUGH THE HALLOW CORE? AND NOW YOU LEAD THEM TO MY VERY LAIR?",
                                                             "WHAT IS THE MEANING OF THIS INTRUSION?",
