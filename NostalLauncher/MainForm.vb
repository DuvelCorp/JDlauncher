...
#Region "Form_Mgt"
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            TSSlog.Text = "Welcome ! "
            TSSversion.Text = "JDlauncher 1.2"
            ...
            ' First install
            If Not File.Exists("JDLauncher.db") Then CreateDatabase()

            ' Retrieve application parameters
            Get_Params()

            ' Change this if we deploy a new version !
            If DB_VERSION < 2 Then UpgradeDatabase()
            ...
            '  TrayIcon.BalloonTipTitle = "JDlauncher"
    ...
    Private Sub ComboBoxCharClass_Load()
        ...
        Try
            ...
            Using (objConn)
                ...
                objCommand.CommandText = "SELECT ClassID, ClassName FROM class WHERE WoWversionID<=2  ORDER BY ClassName"
                objReader = objCommand.ExecuteReader()
                While (objReader.Read())
    ...
    Private Sub ComboBoxCharRace_Load()
        ...
        Try
            ...
            Using (objConn)
                ...
                objCommand.CommandText = "SELECT RaceID, RaceName FROM race WHERE WoWversionID<=2 AND RaceFaction='" & strFaction & "' ORDER BY RaceName"
                objReader = objCommand.ExecuteReader()
                While (objReader.Read())
...
#Region "Overview_Mgt"
    ...
    Private Sub TreeViewLauncher_Load()
        ...
        Try
            LinkLabelExpandTV.Visible = False
            ...
            Using (conn)
                ...
                While (objReader.Read())
                    ...
                    If oldVersion <> CInt(objReader("wowversionID")) Then
        ...
        Try
            ...
            Using (conn)
                ...
                While (objReader.Read())
                    ...
                    If (objReader("WoWversionID")) = 2 Then
                        PictureBoxOverviewVersion.Image = My.Resources.V2_large
                        PictureBoxOverviewVersion.Tag = "V2"
                    Else
                        PictureBoxOverviewVersion.Image = My.Resources.V1_large
    ...
    Private Sub PictureBoxOverviewVersion_Click(sender As Object, e As EventArgs) Handles PictureBoxOverviewVersion.Click
        Try
            ...
            If PictureBoxOverviewVersion.Tag = "V2" Then
...
#Region "Settings_Mgt"
    ...
    Private Sub LinkLabelExpandTV_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabelExpandTV.LinkClicked
        Try
            TreeViewLauncher.ExpandAll()
    ...
    Private Sub LinkLabelJambon_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabelJambon.LinkClicked
        Try
    ...
    Private Sub LinkLabelRaidstats_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabelRaidstats.LinkClicked
        Try
    ...
    Private Sub PictureBoxPaypal_Click(sender As Object, e As EventArgs) Handles PictureBoxPaypal.Click
        Try
            System.Diagnostics.Process.Start("https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=AJUA3SKJEGEQC&lc=US&item_name=JDlauncher&currency_code=EUR&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted")
        Catch ex As Exception
            MessageBox.Show("Error: " & ex.Message)
        End Try
    End Sub
